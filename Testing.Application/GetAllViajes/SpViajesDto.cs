...
/// <summary>
/// Forma EXACTA de una fila de [Operaciones].[sp_ConsultaViajesZemog]. 
/// EF Core 10 resuelve <c>Database.SqlQueryRaw&lt;TResult&gt;</c> para un tipo no mapeado exigiendo que TODAS sus propiedades tengan una columna correspondiente en el resultado
/// </summary>
public sealed class SpViajesDto
{
    [Column("base")]
